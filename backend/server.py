...
# NOTA: Endpoint PUT /motoristas/{motorista_id}/approve migrado para routes/motoristas.py
...
async def update_vehicle(vehicle_id: str, updates: Dict[str, Any], current_user: Dict = Depends(get_current_user)):
    ...
    # 🆕 NOVA ARQUITETURA: Cartões ficam no motorista, não são copiados do veículo
...
# ==================== CARTÕES DE FROTA ENDPOINTS ====================

@api_router.post("/cartoes-frota", response_model=CartaoFrota)
...
@api_router.get("/cartoes-frota/{cartao_id}", response_model=CartaoFrota)
...
@api_router.put("/cartoes-frota/{cartao_id}")
...
@api_router.delete("/cartoes-frota/{cartao_id}")
...
@api_router.get("/cartoes-frota/disponiveis/{tipo}")
