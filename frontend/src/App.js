...
import SincronizacaoHub from "@/pages/SincronizacaoHub";
...
import PrecosEspeciais from "@/pages/admin/PrecosEspeciais";
    ...
    <div className="App">
      <BrowserRouter>
        <Routes>
          ...
          />
          <Route
            path="/progressoes-motoristas"
            element={
              user ? <ProgressoesMotoristas user={user} onLogout={handleLogout} /> : <Navigate to="/login" />
            }
          />
          <Route
            path="/comissoes"
          ...
          />
          <Route
            path="/vistorias-mobile"
            element={
              user && (user.role === 'admin' || user.role === 'gestao' || user.role === 'parceiro') ? <VistoriasMobile user={user} onLogout={handleLogout} /> : <Navigate to="/" />
            }
          />
          <Route
            path="/inspetores"
          ...
          />
          <Route
            path="/admin/gestao-planos"
            element={
              user && user.role === 'admin' ? (
                <AdminGestaoPlanos user={user} onLogout={handleLogout} />
              ) : (
                <Navigate to="/login" />
              )
            }
          ...
          <Route
            ...
            element={
              user && user.role === 'admin' ? (
                <AdminComissoes user={user} onLogout={handleLogout} />
              ) : (
                <Navigate to="/login" />
              )
            }
          ...
          <Route
            ...
            element={
              user && user.role === 'admin' ? (
                <GestaoFuncionalidades user={user} onLogout={handleLogout} />
              ) : (
                <Navigate to="/login" />
              )
            }
          ...
          <Route
            ...
            element={
              user && user.role === 'admin' ? (
                <GestaoServicos user={user} onLogout={handleLogout} />
              ) : (
                <Navigate to="/login" />
              )
            }
