// Componentes de Ficha de Veículo - Índice de Exportação
export { default as VeiculoSeguroTab } from './VeiculoSeguroTab';
export { default as VeiculoInspecaoTab } from './VeiculoInspecaoTab';
