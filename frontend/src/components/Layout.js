...
import { 
  ...
  Shield, Bell, Menu, X, Home, User, HardDrive, Building2, MessageCircle, Zap, TrendingUp, Calculator, BarChart3, Fuel
} from 'lucide-react';
    ...
    const items = [
      ...
      { 
        ...
        submenu: [
          ...
          { path: '/empresas-faturacao', label: '🏢 Empresas de Faturação' },
