...
import { Truck, LayoutDashboard, Car, Users, DollarSign, LogOut, Menu, X, Building, UserCircle, FileText, CreditCard, Upload, Settings, Database, Shield, ChevronDown, Zap, TrendingUp, Package, Receipt } from 'lucide-react';
...
const Layout = ({ user, onLogout, children }) => {
  ...
  const getNavItems = () => {
    // For motorista role: Menu completo (8 itens)
