...
import { Plus, TrendingUp, TrendingDown, DollarSign, FileSpreadsheet, FileText, Download } from 'lucide-react';
...
const Financials = ({ user, onLogout }) => {
  ...
  const [selectedParceiro, setSelectedParceiro] = useState('all');
