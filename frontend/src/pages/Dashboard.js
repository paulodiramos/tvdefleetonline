...
import { TrendingUp, TrendingDown, AlertCircle, Calendar, Car, Users, DollarSign, Wrench, AlertTriangle, CheckCircle, XCircle, Eye, EyeOff, X, Shield, ClipboardCheck, FileText, Settings, Upload, Key } from 'lucide-react';
  ...
  return (
    <Layout user={user} onLogout={onLogout}>
      <div className="space-y-6" data-testid="dashboard-page">
        ...
        {/* Alertas Section - Only for Admin, Gestor */}
