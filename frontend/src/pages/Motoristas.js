  ...
  return (
    <Layout user={user} onLogout={onLogout}>
      <div className="space-y-6" data-testid="motoristas-page">
        ...
        {/* Escolher Plano Dialog */}
        <Dialog open={showEscolherPlanoDialog} onOpenChange={(open) => {
          setShowEscolherPlanoDialog(open);
          if (open) fetchPlanosDisponiveis();
          if (!open) setPlanoSelecionado(null);
        }}>
          <DialogContent className="max-w-2xl">
            <DialogHeader>
              <DialogTitle>Atribuir Plano ao Motorista</DialogTitle>
            </DialogHeader>
                      ...
                      >
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            ...
                            <p className="text-sm text-slate-600 mt-2">{plano.descricao}</p>
                            
                            {/* Features */}
                            {plano.features && plano.features.length > 0 && (
                              <div className="mt-3">
                                <p className="text-xs font-semibold text-slate-700 mb-1">Funcionalidades:</p>
