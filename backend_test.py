...
class FleeTrackTester:
    ...
    def test_fleetrack_backend_apis(self):
        ...
        print("2. Via Verde Weekly Reports API - POST /api/relatorios/motorista/{id}/gerar-semanal")
        print("3. Despesas Resumo API - GET /api/despesas/resumo (NEW LOGIC)")
        print("4. Report Delete API - DELETE /api/relatorios/semanal/{id}")
        print("5. Report Status Change API - PUT /api/relatorios/semanal/{id}/status")
        print("6. List Reports for Parceiro - GET /api/relatorios/semanais-todos")
        print("7. CSV Import API - POST /api/despesas/importar")
        print("8. List Despesas API - GET /api/despesas/")
        print("=" * 80)
